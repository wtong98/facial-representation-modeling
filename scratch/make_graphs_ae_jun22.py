...
configs = [
    ...
    ModelData('vae1024', '../save/ae1024_jun19/final.pt',
              {'latent_dims': 1024}),
    ModelData('vae2048', '../save/ae2048_jun19/final.pt',
              {'latent_dims': 2048}),
    ModelData('vae4096', '../save/ae4096_jun19/final.pt',
              {'latent_dims': 4096}),
    ModelData('vae8192', '../save/ae8192_jun19/final.pt',
              {'latent_dims': 8192}),
    ModelData('vae16384', '../save/ae16384_jun19/final.pt',
              {'latent_dims': 16384}),
]
